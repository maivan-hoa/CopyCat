...
model = VGG19(num_classes=5) #to compile the model
model.to(device) #to send the model for training on either cuda or cpu

epochs = 15
batch_size = 32
lr = 1e-3
milestones = [5, 10, 15, 20, 25, 30, 35]
path_save = './snapshots/Model_VGG19_NPD_SL.pth'

dataset_path = './data/ImageNet_SL_80'
trainsize = 224
